...
.PHONY: help setup run strict test fixtures demo demo-terminal clean timings
...
clean:
	rm -rf out demo/out demo/out-terminal demo/.toolchain demo/.scratch .pytest_cache
